...
import { setUserInfoData } from 'redux/actions';
...
export default function CCLeague() {
        ...
        const isLeague = trackingId != null && cardSubType == 'LEAGUE' ? true : false; 
        ...
        const UpdatePageDetail = async (event) => {
          let data = { "trackingId": trackingId, "pageName": "PROFESSIONAL_DETAILS_PAGE_SHOWN" };
          try {
        ...
        <div>
            ...
            <Container maxWidth="md">
                ...
                <Grid container justifyContent="center">
                    ...
                    <img
                src={`${publicRuntimeConfig.MY_VAR}/Images/league-card.png`} alt="Unsecured Card" style={{maxWidth: "100%"}} />
